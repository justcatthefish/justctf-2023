...
const products = [{
  ...
  description: "Introducing the <strong>exclusive</strong> 1,000,000 jCTF Social API Request Bundle - the ultimate solution for businesses and individuals who want to maximize their reach on the jCTF social network. This bundle includes a massive one million API requests, allowing you to access the full range of features offered by jCTF and connect with your target audience with ease.",
  price: '$40,000',
  tax: '23%',
  country: 'Poland',
  ...
  description: "Introducing the <strong>exclusive</strong> 2,000,000 jCTF Social API Request Bundle - the ultimate solution for businesses and individuals who want to maximize their reach on the jCTF social network. This bundle includes a massive one million API requests, allowing you to access the full range of features offered by jCTF and connect with your target audience with ease.",
  price: '$100,000',
  tax: '23%',
  country: 'Poland',
  image: '/img/server.jpg'
